...
export default function HomeClient({ initialPackages }: { initialPackages: any[] }) {
  ...
  return (
    <main className="bg-slate-50 min-h-screen text-slate-800">
      ...
      <section className="bg-[#0b1c3e] border-t border-[#d4af37]/30 text-white py-6 px-6 relative overflow-hidden">
        {/* Subtle decorative glow */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[150px] bg-[#d4af37]/5 rounded-full blur-[80px] pointer-events-none" />
        
        <div className="max-w-6xl mx-auto relative z-10 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="text-center md:text-left">
            <h2 className="font-heading text-lg md:text-xl font-extrabold tracking-tight mb-1 text-white">
              Booking Cancellation & Refund
            </h2>
            <p className="text-slate-300 text-sm md:text-base leading-relaxed">
              Need help with a cancellation? Submit a request or review our refund policy.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 w-full md:w-auto">
            <a 
              href="/cancel-booking"
              className="w-full sm:w-auto px-6 py-2.5 rounded-full border border-white/30 hover:border-white/60 bg-white/5 hover:bg-white/10 font-semibold transition-all duration-200 text-center flex items-center justify-center gap-2 text-white text-sm"
            >
